...
util.AddNetworkString("ixFrequency")
util.AddNetworkString("ixCombineDisplayMessage")
util.AddNetworkString("ixViewData")
util.AddNetworkString("ixViewDataUpdate")
util.AddNetworkString("ixViewObjectivesUpdate")
util.AddNetworkString("ixViewObjectives")
...
net.Receive("PlayerChatTextChanged", function (lenght, client)
	local chatTypes = {
		["ic"] = true,
		["w"] = true,
		["y"] = true,
	...
	if (client:IsCombine() and chatTypes[chatType]) then
		client:EmitSound("NPC_MetroPolice.Radio.On")
	end
end)

net.Receive("PlayerFinishChat", function (lenght, client)
	if (client:IsCombine()) then
		client:EmitSound("NPC_MetroPolice.Radio.Off")
	end
end)

net.Receive("ixViewDataUpdate", function(lenght, client) 
	local target, text = net.ReadEntity(), net.ReadString()
...
net.Receive("ixViewObjectivesUpdate", function(lenght, client)
