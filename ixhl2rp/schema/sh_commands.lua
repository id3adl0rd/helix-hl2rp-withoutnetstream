...
do
	...
	function COMMAND:OnRun(client, target)
		...
		net.Start("ixViewData")
			net.WriteEntity(targetClient)
			net.WriteString(target:GetData("cid") or "")
			net.WriteTable(target:GetData("combineData", {}))
		net.Send(client)
	end
