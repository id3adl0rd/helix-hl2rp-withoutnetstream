...
util.AddNetworkString("ixWritingEdit")
util.AddNetworkString("ixViewPaper")

net.Receive("ixWritingEdit", function(lenght, client)
	local itemID, text = net.ReadUInt(32), net.ReadString()
